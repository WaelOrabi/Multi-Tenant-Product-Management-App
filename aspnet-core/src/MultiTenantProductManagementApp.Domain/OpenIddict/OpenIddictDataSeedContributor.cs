...
namespace MultiTenantProductManagementApp.OpenIddict;
...
public class OpenIddictDataSeedContributor : IDataSeedContributor, ITransientDependency
{
    ...
    {
        if (await _openIddictScopeRepository.FindByNameAsync("MultiTenantProductManagementApp") == null)
        {
            await _scopeManager.CreateAsync(new OpenIddictScopeDescriptor {
                Name = "MultiTenantProductManagementApp", DisplayName = "MultiTenantProductManagementApp API", Resources = { "MultiTenantProductManagementApp" }
            });
        }
    }
    ...
    private async Task CreateApplicationsAsync()
    {
        var commonScopes = new List<string> {
            ...
            "MultiTenantProductManagementApp"
        };
        ...
        var consoleAndAngularClientId = configurationSection["MultiTenantProductManagementApp_App:ClientId"];
        if (!consoleAndAngularClientId.IsNullOrWhiteSpace())
        {
            var consoleAndAngularClientRootUrl = configurationSection["MultiTenantProductManagementApp_App:RootUrl"]?.TrimEnd('/');
        ...
        // Swagger Client
        var swaggerClientId = configurationSection["MultiTenantProductManagementApp_Swagger:ClientId"];
        if (!swaggerClientId.IsNullOrWhiteSpace())
        {
            var swaggerRootUrl = configurationSection["MultiTenantProductManagementApp_Swagger:RootUrl"]?.TrimEnd('/');
